...
import { fetchLabTestOfMedicalRecordPatientApi } from "../../../api/apiService/patient/MedicalRecord";

const PatientLabOrderViewPage: React.FC = () => {
  const { id: recordId } = useParams();

  const navigate = useNavigate();

  const { data, isPending, error, refetch } = useQuery<LabOrderData>({
    queryKey: ["medical-record:lab:tests", recordId],
    queryFn: () => fetchLabTestOfMedicalRecordPatientApi(recordId!),
  });
...
export default PatientLabOrderViewPage;
